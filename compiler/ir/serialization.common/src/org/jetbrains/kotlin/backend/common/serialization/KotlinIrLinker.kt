...
import org.jetbrains.kotlin.ir.builders.FrontEndPluginContext
...
abstract class KotlinIrLinker(
    ...
    abstract val frontEndPluginContext: FrontEndPluginContext?
...
//        moduleDeserializer.deserializeIrSymbol(signature, symbol.kind())
    ...
    private fun tryResolveCustomDeclaration(symbol: IrSymbol): IrDeclaration? {
        ...
        return frontEndPluginContext?.let { ctx ->
